...
const Title = styled.h1<{ os?: string }>`
  font-size: 5em;
  margin: ${props => props.os === "Win" ? "5px 0 45px 0" : 0};
...
export default function Landing() {
	...
	const { playlist, progress, os, toggleEnter } = useStore( state => ( {
	...
	return (
		<Container ref={vantaRef} entered={enter}>
			<Content>
				...
				<Title os={os}>Isaiah Anyimi</Title>
				<SubText>
