...
const FILE_URL = "https://dqeczc7c9n9n1.cloudfront.net/models/dolorean4-1659385435/dolorean4.glb.gz";
const TOTAL_MESHES = "";
...
export default function Model( props: JSX.IntrinsicElements['group'] ) {
	...
	// const reflectMat = new MeshReflectorMaterial( {
	// 	blur: [ 400, 100 ],
	// 	resolution: 1024,
	// 	mixBlur: 1,
	// 	opacity: 2,
	...
	useEffect( () => {
		...
		if ( ! isMounted.current ) {
			...
			group.current.traverseVisible( ( obj: Object3D ) => {

				if ( ! ( obj instanceof Mesh ) || ! obj.userData.metallic ) return;
				console.log( "metallic" );
				// obj.material = reflectMat;
		...
		<group ref={group} scale={0.05} position={[ - 0.1, 0.075, 0.1 ]} rotation-x={Math.PI / 12} {...props} dispose={null}>
			<group name="Scene">
				<group name="dolorean4glb">
					...
					/>
					<mesh
						name="CPDeLorean_MainBody002_Body"
