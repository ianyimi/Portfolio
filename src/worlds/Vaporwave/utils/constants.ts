...
export const playlists: Playlist[] = [
	{
		...
		palettes: [
			...
			parse( "https://coolors.co/00171f-ffffff-003459-007ea7-00a8e8" ),
	...
	},
	{
		...
		palettes: [
			...
			parse( "https://coolors.co/fefeff-f71735-0eb1d2-2e5eaa-000000" ),
			parse( "https://coolors.co/fefeff-f71735-b118c8-2e3532-000000" ),
		],
		backgroundColorIndex: 0,
		mainColorIndex: 1,
		secondaryColorIndex: 2,
	...
	},
	{
		...
		palettes: [
			...
			parse( "https://coolors.co/e63946-f1faee-a8dadc-457b9d-1d3557" ),
