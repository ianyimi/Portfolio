...
type GLTFResult = GLTF & {
  nodes: {
    Tire_Valve005: THREE.Mesh
    Tire005: THREE.Mesh
    Wheel_Cover001: THREE.Mesh
    Wheel_Cover005: THREE.Mesh
    Wheel_Logo005: THREE.Mesh
    Tire_Valve004: THREE.Mesh
    Tire004: THREE.Mesh
    Wheel_Cover003: THREE.Mesh
    Wheel_Cover004: THREE.Mesh
    Wheel_Logo004: THREE.Mesh
    Tire: THREE.Mesh
    Tire_Valve: THREE.Mesh
    Wheel_Cover: THREE.Mesh
    Wheel_Cover007: THREE.Mesh
    Wheel_Logo: THREE.Mesh
    Tire_Valve006: THREE.Mesh
    Tire006: THREE.Mesh
    Wheel_Cover002: THREE.Mesh
    Wheel_Cover006: THREE.Mesh
    Wheel_Logo006: THREE.Mesh
    Alarm02: THREE.Mesh
    Alarm03: THREE.Mesh
    Alarm04: THREE.Mesh
    Alarm05: THREE.Mesh
  ...
  materials: {
    ...
    ['Mercedes-Benz 190 SL.030']: THREE.MeshStandardMaterial
    ...
    ['Mercedes-Benz 190 SL.070']: THREE.MeshStandardMaterial
...
const FILE_URL = "https://dqeczc7c9n9n1.cloudfront.net/models/sl190-1661023180/sl190.glb.gz";
	...
	return (
		<group ref={group} {...props} dispose={null}>
			<group name="Scene" rotation-y={Math.PI / 2}>
				<group name="Tire4" rotation={[ 0, - 1.5705, 0 ]} scale={0.01} >
					<mesh
						name="Tire_Valve005"
						geometry={nodes.Tire_Valve005.geometry}
						material={nodes.Tire_Valve005.material}
						position={[ 29.0606, 0.022, - 9.6526 ]}
					/>
					<mesh
						name="Tire005"
						geometry={nodes.Tire005.geometry}
						material={nodes.Tire005.material}
						position={[ - 104.7127, 32.3663, - 17.8668 ]}
					/>
					<mesh
						name="Wheel_Cover001"
						geometry={nodes.Wheel_Cover001.geometry}
						material={nodes.Wheel_Cover001.material}
						position={[ - 104.7183, 32.3718, - 26.0422 ]}
					/>
					<mesh
						name="Wheel_Cover005"
						geometry={nodes.Wheel_Cover005.geometry}
						material={nodes.Wheel_Cover005.material}
						position={[ - 104.7184, 32.3718, - 26.0427 ]}
					/>
					<mesh
						name="Wheel_Logo005"
						geometry={nodes.Wheel_Logo005.geometry}
						material={nodes.Wheel_Logo005.material}
						position={[ 29.0606, 0.022, - 9.6526 ]}
					/>
				</group>
				<group name="Tire3" rotation={[ 0, - 1.5705, 0 ]} scale={0.01}>
					<mesh
						name="Tire_Valve004"
						geometry={nodes.Tire_Valve004.geometry}
						material={nodes.Tire_Valve004.material}
						position={[ 27.3136, - 6.4659, 122.106 ]}
					/>
					<mesh
						name="Tire004"
						geometry={nodes.Tire004.geometry}
						material={nodes.Tire004.material}
						position={[ - 104.7025, 32.4079, 130.4447 ]}
					/>
					<mesh
						name="Wheel_Cover003"
						geometry={nodes.Wheel_Cover003.geometry}
						material={nodes.Wheel_Cover003.material}
						position={[ 27.3136, - 6.4659, 122.106 ]}
					/>
					<mesh
						name="Wheel_Cover004"
						geometry={nodes.Wheel_Cover004.geometry}
						material={nodes.Wheel_Cover004.material}
						position={[ 27.3137, - 6.4659, 122.1059 ]}
					/>
					<mesh
						name="Wheel_Logo004"
						geometry={nodes.Wheel_Logo004.geometry}
						material={nodes.Wheel_Logo004.material}
						position={[ 27.3136, - 6.4659, 122.106 ]}
					/>
				</group>
				<group name="Tire1" rotation={[ 0, - 1.5705, 0 ]} scale={0.01}>
					<mesh
						name="Tire"
						geometry={nodes.Tire.geometry}
						material={nodes.Tire.material}
						position={[ 131.3923, 32.3663, 130.3345 ]}
					/>
					<mesh
						name="Tire_Valve"
						geometry={nodes.Tire_Valve.geometry}
						material={nodes.Tire_Valve.material}
						position={[ - 2.3811, 0.022, 122.1197 ]}
					/>
					<mesh
						name="Wheel_Cover"
						geometry={nodes.Wheel_Cover.geometry}
						material={nodes.Wheel_Cover.material}
						position={[ - 2.3812, 0.022, 122.1197 ]}
					/>
					<mesh
						name="Wheel_Cover007"
						geometry={nodes.Wheel_Cover007.geometry}
						material={nodes.Wheel_Cover007.material}
						position={[ - 2.3811, 0.022, 122.1197 ]}
					/>
					<mesh
						name="Wheel_Logo"
						geometry={nodes.Wheel_Logo.geometry}
						material={nodes.Wheel_Logo.material}
						position={[ - 2.3811, 0.022, 122.1197 ]}
					/>
				</group>
				<group name="Tire2" rotation={[ 0, - 1.5705, 0 ]} scale={0.01}>
					<mesh
						name="Tire_Valve006"
						geometry={nodes.Tire_Valve006.geometry}
						material={nodes.Tire_Valve006.material}
						position={[ - 0.597, - 6.4659, - 9.6386 ]}
					/>
					<mesh
						name="Tire006"
						geometry={nodes.Tire006.geometry}
						material={nodes.Tire006.material}
						position={[ 131.4193, 32.4079, - 17.9773 ]}
					/>
					<mesh
						name="Wheel_Cover002"
						geometry={nodes.Wheel_Cover002.geometry}
						material={nodes.Wheel_Cover002.material}
						position={[ - 0.597, - 6.4659, - 9.6386 ]}
					/>
					<mesh
						name="Wheel_Cover006"
						geometry={nodes.Wheel_Cover006.geometry}
						material={nodes.Wheel_Cover006.material}
						position={[ - 0.5969, - 6.4659, - 9.6387 ]}
					/>
					<mesh
						name="Wheel_Logo006"
						geometry={nodes.Wheel_Logo006.geometry}
						material={nodes.Wheel_Logo006.material}
						position={[ - 0.597, - 6.4659, - 9.6386 ]}
					/>
				</group>
				<group name="Car01" scale={0.01}>
					...
					<mesh
						name="Moquet_Border"
						geometry={nodes.Moquet_Border.geometry}
						material={materials[ 'Mercedes-Benz 190 SL.070' ]}
						position={[ - 124.3112, 0.022, - 2.3801 ]}
					/>
					<mesh
						name="Moquet001"
					...
					<mesh
						name="Radio_Speaker"
						geometry={nodes.Radio_Speaker.geometry}
						material={nodes.Radio_Speaker.material}
						position={[ - 56.5239, 64.2404, 51.1513 ]}
					/>
					<mesh
